...
(function() {
  ...
  function buildCard(v) {
    var catName   = v.categoria === 'rodoviario' ? 'Rodoviário' : v.categoria === 'urbano' ? 'Urbano' : 'Micro';
    var destBadge = v.destaque ? '<span class="bus-badge badge-highlight">Destaque</span>' : '';
    return '<div class="bus-card reveal" data-type="' + v.categoria + '">' +
